...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $sql = "INSERT INTO classroom (roomNumber, name, capacity,status)" .
                "VALUES ('$roomNumber', '$name','$capacity', 1)";
        ...
        <form method="post">
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control text" name="roomNumber" value="<?php echo $roomNumber; ?>">
                </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <!-- Input para la fecha de fin con el selector -->
                    <input type="text" class="form-control text" name="capacity" value="<?php echo $capacity; ?>">
                </div>
            </div>
            <?php
            ...
            <div class="row mb-3">
                ...
                <a class="btn btn-light btn-sm'" href="/web/Area_Academica/Classroom/tableClassroom.php" role="button">Regresar</a>
                </div>
            </div>
        </form>
    </div>
