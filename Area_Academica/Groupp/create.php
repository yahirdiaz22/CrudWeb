...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        if (empty($groupName) || empty($numberOfStudents)) {
            $errorMessage = "Llena todos los campos";
            break;
        }

        $sql = "INSERT INTO groupp (groupName, numberOfStudents, status)" .
                "VALUES ('$groupName', '$numberOfStudents', 1)";
        ...
        <form method="post">
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control text" name="groupName" value="<?php echo $groupName; ?>">
                </div>
            </div>
            <div class="col-sm-6">
                <label class="col-sm-3 col-form-label">Numero de estudiantes</label>
                <div class="col-sm-6">
                    <!-- Input para la fecha de fin con el selector -->
                    <input type="text" class="form-control text" name="numberOfStudents" value="<?php echo $numberOfStudents; ?>">
                </div>
            </div>
            <?php
            ...
            <div class="row mb-3">
                ...
                <a class="btn btn-light btn-sm'" href="/web/Area_Academica/Groupp/tableGroupp.php" role="button">Regresar</a>
                </div>
            </div>
        </form>
    </div>
