...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        if (empty($startDate) || empty($endDate) || empty($contractType) || empty($salary)) {
            $errorMessage = "Llena todos los campos";
            break;
        }

        $sql = "INSERT INTO contract (startDate, endDate, contractType, salary, status)" .
                "VALUES ('$startDate', '$endDate', '$contractType', '$salary', 1)";
    ...
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <a class="btn btn-light btn-sm'" href="/web/Area_Academica/Contract/tableContract.php" role="button">Regresar</a>
                </div>
            </div>
        </form>
    </div>
