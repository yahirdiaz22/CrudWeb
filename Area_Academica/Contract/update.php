...
$idContract = $startDate = $endDate = $contractType = $salary = $errorMessage = $successMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    do {
        if (empty($idContract) || empty($startDate) || empty($endDate) || empty($contractType) || empty($salary)) {
            $errorMessage = "Llena todos los campos";
            break;
        }

        $sql = "UPDATE contract " .
            "SET startDate = '$startDate', endDate = '$endDate', contractType = '$contractType', salary = '$salary' " .
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-light btn-sm" href="\web\Area_Academica\Contract\tableContract.php" role="button">Regresar</a>
                </div>
            </div>
        </form>
    </div>
