...
$idEvent = $idStudent = $errorMessage = $successMessage = "";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        if (empty($idEvent) || empty($idStudent)) {
            $errorMessage = "Llena todos los campos";
            break;
        }

        $sql = "INSERT INTO eventstudent (idEvent, idStudent)" .
                "VALUES ('$idEvent', '$idStudent')";
        ...
        $idEvent = $idStudent = "";
        $successMessage = "Se añadió el evento y estudiante";
...
<body>
    <div class="container my-5">
        <h2>Nuevo Evento y Estudiante</h2>
        <?php
        ...
        <form method="post">
                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-select" name="idStudent">
                        ...
                        while ($student = $resultStudents->fetch_assoc()) {
                            echo "<option value='{$student['idStudent']}'>{$student['fullName']}</option>";
                        }
                        ?>
                    </select>
                </div>
            ...
            <div class="row mb-3">
                ...
                <a class="btn btn-light btn-sm'" href="/web/Area_Academica/EventStudent/tableEventStudent.php" role="button">Regresar</a>
                </div>
            </div>
        </form>
    </div>
