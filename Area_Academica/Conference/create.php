...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        if (empty($nameConference) || empty($startDate)|| empty($endDate)|| empty($location)|| empty($idDepartment)) {
            $errorMessage = "Llena todos los campos";
            break;
        }

        $sql = "INSERT INTO conference (nameConference, startDate, endDate,location,idDepartment)" .
...
<body>
    <div class="container my-5">
        ...
        <form method="post">
            <div class="col-sm-6">
                <label class="col-sm-3 col-form-label"> nameConference</label>
                <div class="col-sm-6">
                    <!-- Input para la fecha de inicio con el selector -->
                    <input type="text" class="form-control text" name="nameConference" value="<?php echo $nameConference; ?>">
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <select class="form-control" name="idDepartment"placeholder="Select the Department">
          <?php 
  ...
  ?>
            ...
            <div class="row mb-3">
                ...
                <a class="btn btn-light btn-sm'" href="/web/Area_Academica/Conference/tableConference.php" role="button">Regresar</a>
                </div>
            </div>
        </form>
    </div>
